 ...
 * @author DELL
 */
public class ClienteCore extends Thread implements UtilitiarioCliente{
    /**
     ...
     */        
    private final ClienteFrame ventana;    
    /**
     ...
     * @param nombre 
     */
    ClienteCore(ClienteFrame ventana, String host, Integer puerto, String nombre) {
